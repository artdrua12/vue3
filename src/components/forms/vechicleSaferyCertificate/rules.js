...
export const createSBKTS = {
  ...
  export const commonRules ={
    ...
    vehicleMaxUnbrakedTrailerWeightMeasure: value => {
      let rule1 = true;
      let rule2 = true;
      console.log($this.formModel.notVehicleTrailerIndicator);
      console.log(value);
      console.log(!$this.formModel.vehicleMaxBrakedTrailerWeightMeasure.value);
    ...
    vehicleMaxBrakedTrailerWeightMeasure: value => {
      ...
      if ($this.formModel.notVehicleTrailerIndicator) {
        if (
          (value == 0 || !value) &&
          !$this.formModel.vehicleMaxUnbrakedTrailerWeightMeasure.value
        ) {
          rule1 = false;
        }
        rule2 = func.valueInValues({
