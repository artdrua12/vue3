<template>
  <v-form ref="form" :disabled="isLook" class="mt-5">
    <base-constructor
      ...
      :filter-data="shema.vehicleVariantDetails.vehicleRunningGearDetails.vehicleSuspensionDetails"
      :default-data="
        shemaDefault.vehicleVariantDetails.vehicleRunningGearDetails.vehicleSuspensionDetails[0]
      "
      class="full"
      label="Подвеска"
      :disabled="isLook"
