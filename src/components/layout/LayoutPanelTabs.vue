  ...
  <div class="panel-layot">
    ...
    <div class="panels">
      ...
      >
        ...
        <div v-if="item.panels" class="tabsWrapper">
          <v-tabs v-model="model" align-tabs="right">
            <v-tab v-for="itm in item.panels" :key="itm" :value="itm"> {{ itm }} </v-tab>
          </v-tabs>

          <v-window v-model="model">
            <v-window-item v-for="itm in item.panels" :id="itm" :key="itm" :value="itm">
              <p>{{ text }}</p>
            </v-window-item>
          </v-window>
